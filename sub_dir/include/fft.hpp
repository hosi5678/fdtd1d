...
//
   ...
   //       }
	...
	// _temp=peak;
		...
		// std::cout << "fft_vec.size: " << fft_vec.size() << endl;
	// _temp=fft_vec;
	// _temp.show(20);
	...
	// 	wave.push_back(_wave[i]);
	// }

// std::vector<double> fft::getPeak(std::vector<double> vec) {

// 	 vec1d _temp=vec;

// 	_temp.createFile(20,"csv_files","pre_peak.csv");

// 	std::vector <double> _peak;

// 	_temp.get_peak(_temp,peak_limit);

// 	_temp.show(20);

// 	_temp.createFile(20,"csv_files","fft_peak.csv");
